...
class CrateInfo {
  ...
  static CrateInfo parseManifest(String manifest, {final String? fileName}) {
    ...
    // Check for [lib] name, fallback to package name with hyphens replaced by underscores
    final lib = tomlMap['lib'];
    final libName = lib?['name'] ?? (name as String).replaceAll('-', '_');
