...
// These functions are ignored because they are not marked as `pub`: `configure_rule_providers`, `convert_ffi_config_to_core`, `decode_options`, `decrypt`, `encrypt`, `get_cpu_name`, `init_tracing_safe`, `local_proxy_addr`, `new`, `next_nonce`, `parse_inbound_type`, `parse_outbound_type`, `parse_proxy_mode`, `parse_rule_type`, `ss_build_address_header`, `ss_cipher_spec`, `ss_derive_subkey`, `ss_recv_decrypted_chunk`, `start_android_vpn_inner`, `stop_android_vpn_inner`, `stop_windows_tun_runtime`, `test_via_http_proxy`
