...
static WINDOWS_VPN_PROCESSOR: once_cell::sync::Lazy<
    Arc<parking_lot::RwLock<Option<Arc<veloguard_netstack::WindowsVpnProcessor>>>>,
> = once_cell::sync::Lazy::new(|| Arc::new(parking_lot::RwLock::new(None)));

/// Global Windows route manager
#[cfg(windows)]
static WINDOWS_ROUTE_MANAGER: once_cell::sync::Lazy<
    Arc<parking_lot::RwLock<Option<veloguard_netstack::WindowsRouteManager>>>,
> = once_cell::sync::Lazy::new(|| Arc::new(parking_lot::RwLock::new(None)));
...
) -> Option<parking_lot::MappedRwLockReadGuard<'static, veloguard_netstack::WindowsRouteManager>> {
...
) -> Option<parking_lot::MappedRwLockWriteGuard<'static, veloguard_netstack::WindowsRouteManager>> {
